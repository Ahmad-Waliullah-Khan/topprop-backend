...
let CRON_TIMING_ONGOING_MATCHES_CRON = "";
...
switch (cronEnv) {
  case "development":
      ...
      CRON_TIMING_SYNC_GAMES_CRON = '0 * * * * *';
      CRON_TIMING_ONGOING_MATCHES_CRON = '0 */1 * * * *';
    break;
  case "staging":
      ...
      CRON_TIMING_SYNC_TEAMS_CRON = '0 45 * * * *';
      CRON_TIMING_SYNC_GAMES_CRON = '0 30 * * * *';
      CRON_TIMING_ONGOING_MATCHES_CRON = '0 */5 * * * *';
    break;
  case "production":
      CRON_TIMING_PLAYERS_CRON = '0 */1 * * * *';
      CRON_TIMING_SPECIAL_TEAMS_CRON = '0 */1 * * * *';
...
export const ONGOING_MATCHES_CRON_TIMING = CRON_TIMING_ONGOING_MATCHES_CRON;
