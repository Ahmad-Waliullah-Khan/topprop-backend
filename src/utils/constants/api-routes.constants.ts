...
export const API_ENDPOINTS = {
    ...
    LEAGUE_IMPORT: {
        ...
        IMPORT_LEAGUE_ESPN: `${BASE_API_PATH}/${API_VERSIONS.V1}/${API_RESOURCES.LEAGUE_IMPORT}/import-espn`,
        IMPORT_LEAGUE_YAHOO: `${BASE_API_PATH}/${API_VERSIONS.V1}/${API_RESOURCES.LEAGUE_IMPORT}/import-yahoo-league`,
    },
};
